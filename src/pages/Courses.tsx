              ...
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="p-6 md:w-3/4">
                    ...
                    {course.slug && ['motor-vehicle-mechanics', 'electrical-installation', 'plumbing-technology', 'information-communication-technology', 'carpentry-and-joinery', 'hairdressing-and-beauty-therapy', 'arc-welding', 'fashion-design-and-garment-making'].includes(course.slug) ? (
